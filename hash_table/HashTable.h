...
public:
    ...
    int search(int key, string &value) const; // Search for a value by key. Value is changed via reference. Returns 1 or 0 whether a value with that key was found or not.
